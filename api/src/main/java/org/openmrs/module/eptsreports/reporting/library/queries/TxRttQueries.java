  ...
  public static String getTreatmentInterruptionOfXDaysBeforeReturningToTreatmentQuery(
    ...
    String query =
        "SELECT  patient_id "
            ...
            + "                                   AND enc.encounter_datetime <= DATE_ADD(:endDate, interval -1 DAY) "
            ...
            + "                                    e.voided = 0 and "
            + "                                    e.encounter_datetime <= DATE_ADD(:endDate, interval -1 DAY) "
            + "                                 INNER JOIN obs o on "
            ...
            + "                          AND enc.location_id = :location "
            + "                          AND obs.value_datetime <= DATE_ADD(:endDate, interval -1 DAY) "
            + "                        GROUP BY pa.patient_id "
            + "                       ) most_recent "
            + "                  GROUP BY most_recent.patient_id "
            + "                  HAVING final_encounter_date < DATE_ADD(:endDate, interval -1 DAY) "
            + "              ) query_a "
            + "        INNER JOIN ( "
