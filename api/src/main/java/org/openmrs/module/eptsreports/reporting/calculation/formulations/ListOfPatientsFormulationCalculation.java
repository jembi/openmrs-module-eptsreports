...
public class ListOfPatientsFormulationCalculation  extends AbstractPatientCalculation{
    ...
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues, PatientCalculationContext context) {
        ...
        // for (CalculationDataDefinition cdd : calculationDataDefinitions){
        //     cdd.g
        // }
        ...
        List<Integer> formulationConceptIdList  = Arrays.asList(
        ...
        for(Integer patientId:cohort){
            ...
            List<Integer> formulation2ConceptIdList = EptsCalculationUtils.extractResultValues(listResult);
            List<Integer> formulation3ConceptIdList = EptsCalculationUtils.extractResultValues(listResult);
            List<Integer> formulation4ConceptIdList = EptsCalculationUtils.extractResultValues(listResult);
