...
public class ListOfPatientsWithMdsEvaluationCohortQueries {
  ...
  public DataDefinition getMds2StartDate(int numberOfYears) {
    ...
    String query =
        "                  SELECT     mds2_end.patient_id, "
            ...
            + "                  ON         ee2.patient_id = mds2_end.patient_id "
            + "                  INNER JOIN obs ot2 "
            + "                  ON         ot2.encounter_id = ee2.encounter_id "
            + "                  INNER JOIN obs os2 "
            ...
            + "                                 AND  ostate1.value_coded IN (${1256}) ) ) "
            + "                  AND  otype1.obs_group_id = ostate1.obs_group_id "
            + "       GROUP BY mds1.patient_id ) mds1_start "
            + "       ON mds1_start.patient_id = mds1_end.patient_id "
            + "                  WHERE mds1_end.voided = 0 "
            + "                  AND ee.voided = 0 "
            + "                  AND ot.voided = 0 "
            + "                  AND os.voided = 0 "
            + "                  AND ( (ot.concept_id = ${165174} "
            + "                  AND ot.value_coded = mds1_start.first_mds ) "
            ...
            + "                  AND ot2.voided = 0 "
            + "                  AND os2.voided = 0 "
            + "                  AND ee2.encounter_datetime > mds1_end.mds1_end_date "
            + "                  AND ( (ot2.concept_id = ${165174} "
            + "                  AND ot2.value_coded IS NOT NULL ) "
  ...
  public DataDefinition getMds2EndDate(int numberOfYears) {
    ...
    String query =
        "                  SELECT     mds2_end.patient_id, "
            + "                             MIN(enc22.encounter_datetime) AS second_mds_end_date "
            + "                  FROM       patient mds2_end "
            + "                  INNER JOIN encounter enc22 "
            + "                  ON         enc22.patient_id = mds2_end.patient_id "
            + "                  INNER JOIN obs otype22 "
            + "                  ON         otype22.encounter_id = enc22.encounter_id "
            + "                  INNER JOIN obs ostate22 "
            + "                  ON         ostate22.encounter_id = enc22.encounter_id "
            + "                  INNER JOIN ( "
            ...
            + "                  WHERE mds2_end.voided = 0 "
            + "                  AND enc22.voided = 0 "
            + "                  AND otype22.voided = 0 "
            + "                  AND ostate22.voided = 0 "
            + "                  AND        enc22.encounter_type = ${6} "
            + "                  AND        enc22.encounter_datetime > mds_2nd.second_mds_date "
            + "                  AND        enc22.location_id = :location "
            + "                  AND    (   ( otype22.concept_id = ${165174} "
            + "                               AND otype22.value_coded = mds_2nd.second_mds ) "
            + "                  AND         ( ostate22.concept_id = ${165322} "
            + "                                 AND  ostate22.value_coded = ${1267} ) ) "
            + "                  AND  otype22.obs_group_id = ostate22.obs_group_id "
            + "       GROUP BY mds2_end.patient_id "
            + "UNION "
            + "                  SELECT     mds2_end.patient_id, "
            + "                             MIN(enc22.encounter_datetime) AS second_mds_end_date "
  ...
  public DataDefinition getMds3(int numberOfYears) {
    ...
    String query =
        "                  SELECT     mds3.patient_id, "
            ...
            + "                               AND otype3.value_coded > mds_2nd.second_mds ) "
  ...
  public DataDefinition getMds3EndDate(int numberOfYears) {
    ...
    String query =
        "                  SELECT     mds3_end.patient_id, "
            + "                             MIN(enc33.encounter_datetime) AS third_mds_end_date "
            + "                  FROM       patient mds3_end "
            + "                  INNER JOIN encounter enc33 "
            + "                  ON         enc33.patient_id = mds3_end.patient_id "
            + "                  INNER JOIN obs otype33 "
            + "                  ON         otype33.encounter_id = enc33.encounter_id "
            + "                  INNER JOIN obs ostate33 "
            + "                  ON         ostate33.encounter_id = enc33.encounter_id "
            + "                  INNER JOIN ( "
            + "                  SELECT     mds3.patient_id, "
            + "                             MIN(otype3.value_coded) AS third_mds, "
            + "                             MIN(enc3.encounter_datetime) AS third_mds_date "
            ...
            + "                  AND mds3_end.voided = 0 "
            + "                  AND otype33.voided = 0 "
            + "                  AND ostate33.voided = 0 "
            + "                  AND        enc33.encounter_type = ${6} "
            + "                  AND        enc33.encounter_datetime > mds_3rd.third_mds_date "
            + "                  AND        enc33.location_id = :location "
            + "                  AND    (   ( otype33.concept_id = ${165174} "
            + "                               AND otype33.value_coded = mds_3rd.third_mds ) "
            + "                  AND         ( ostate33.concept_id = ${165322} "
            + "                                 AND  ostate33.value_coded = ${1267} ) ) "
  ...
  public DataDefinition getMds4EndDate(int numberOfYears) {
    ...
    String query =
        "                  SELECT     mds4_end.patient_id, "
            + "                             MIN(enc44.encounter_datetime) AS fourth_mds_end_date "
            + "                  FROM       patient mds4_end "
            + "                  INNER JOIN encounter enc44 "
            + "                  ON         enc44.patient_id = mds4_end.patient_id "
            + "                  INNER JOIN obs otype44 "
            + "                  ON         otype44.encounter_id = enc44.encounter_id "
            + "                  INNER JOIN obs ostate44 "
            + "                  ON         ostate44.encounter_id = enc44.encounter_id "
            + "                  INNER JOIN ( "
            + "                  SELECT     mds4.patient_id, "
            + "                             MIN(enc4.encounter_datetime) AS fourth_mds_date, "
            + "                             MIN(otype4.value_coded) AS fourth_mds "
            ...
            + "                  AND enc44.voided = 0 "
            + "                  AND otype44.voided = 0 "
            + "                  AND ostate44.voided = 0 "
            + "                  AND        enc44.encounter_type = ${6} "
            + "                  AND        enc44.encounter_datetime > mds_4th.fourth_mds_date "
            + "                  AND        enc44.location_id = :location "
            + "                  AND    (   ( otype44.concept_id = ${165174} "
            + "                               AND otype44.value_coded = mds_4th.fourth_mds ) "
            + "                  AND         ( ostate44.concept_id = ${165322} "
            + "                                 AND  ostate44.value_coded = ${1267} ) ) "
            + "                  AND  otype44.obs_group_id = ostate44.obs_group_id "
  ...
  public DataDefinition getMds5(int numberOfYears) {
    ...
    String query =
        "                  SELECT     mds5.patient_id, "
            ...
            + "                  AND        enc4.location_id = :location "
            + "                  AND    (   ( otype4.concept_id = ${165174} "
            + "                               AND otype4.value_coded > mds_3rd.third_mds ) "
            + "                  AND         ( ostate4.concept_id = ${165322} "
            + "                                 AND  ostate4.value_coded = ${1256} ) ) "
            + "                  AND  otype4.obs_group_id = ostate4.obs_group_id "
            + "       GROUP BY mds4.patient_id ) mds_4th "
            ...
            + "                               AND otype5.value_coded > mds_4th.fourth_mds ) "
