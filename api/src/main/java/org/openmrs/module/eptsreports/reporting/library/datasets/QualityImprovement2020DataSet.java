...
public class QualityImprovement2020DataSet extends BaseDataSet {
  ...
  public DataSetDefinition constructQualityImprovement2020DataSet() {
    ...
    // de revisão e que eram elegíveis ao pedido de CV",
    //        EptsReportUtils.map(
    //            MQ13DEN1,
    //
    // "startDate=${startDate},endDate=${endDate},revisionEndDate=${revisionEndDate},location=${location}"),
    ...
    //    dataSetDefinition.addColumn(
    //        "MQ13DEN4",
    //        "# de adultos (15/+anos) na 2a linha de TARV que tiveram consulta clínica no período
    // de revisão e que eram elegíveis ao pedido de CV",
    //        EptsReportUtils.map(
    //            MQ13DEN4,
    //
    ...
    // período de revisão e que eram elegíveis ao pedido de CV",
    //        EptsReportUtils.map(
    //            MQ13DEN6,
    //
    // "startDate=${startDate},endDate=${endDate},revisionEndDate=${revisionEndDate},location=${location}"),
    ...
    // no período de revisão e que eram elegíveis ao pedido de CV",
    //        EptsReportUtils.map(
    //            MQ13DEN8,
    //
    // "startDate=${startDate},endDate=${endDate},revisionEndDate=${revisionEndDate},location=${location}"),
    ...
    //    dataSetDefinition.addColumn(
    //        "MQ13DEN13",
    //        "# de crianças na 2a linha de TARV que tiveram consulta clínica no período de revisão
    // e que eram elegíveis ao pedido de CV",
    //        EptsReportUtils.map(
    //            MQ13DEN13,
    //
    // "startDate=${startDate},endDate=${endDate},revisionEndDate=${revisionEndDate},location=${location}"),
    ...
    //    dataSetDefinition.addColumn(
    //        "MQ13DEN3",
    //        "# de Adultos (15/+anos) na 1ª linha de TARV com registo resultado de CV acima de
    // 1000",
    //        EptsReportUtils.map(
    //            MQ13DEN3,
    //
    ...
    //    dataSetDefinition.addColumn(
    //        "MQ13DEN12",
    //        "# de crianças (>2 anos de idade) na 1ª linha de TARV com registo de resultado de CV
    // ≥1000",
    //        EptsReportUtils.map(
    //            MQ13DEN12,
    //
    ...
    // o 4º mês após terem recebido o último resultado de CV ≥1000 cps/ml",
    //        EptsReportUtils.map(
    //            MQ13NUM3,
    //
    // "startDate=${startDate},endDate=${endDate},revisionEndDate=${revisionEndDate},location=${location}"),
    ...
    // entre o 3º e o 4º mês após terem recebido o último resultado de CV ≥1000",
    //        EptsReportUtils.map(
    //            MQ13NUM12,
    //
    // "startDate=${startDate},endDate=${endDate},revisionEndDate=${revisionEndDate},location=${location}"),
    ...
    // terem recebido o último resultado de CV ≥1000",
    //        EptsReportUtils.map(
    //            MQ13NUM18,
    //
    // "startDate=${startDate},endDate=${endDate},revisionEndDate=${revisionEndDate},location=${location}"),
