  ...
  public static String getPatientsListInitiatedOnPREP(
    ...
    String query =
        "SELECT  p.patient_id "
            ...
            + " (o.concept_id=${165211}) "
            + ") "
            + " AND o.value_datetime<'2021-03-21' "
            + " AND e.location_id = :location "
            + " AND p.patient_id IN ( "
            + " SELECT  p.patient_id "
            + " FROM patient p "
            ...
            + " AND e.encounter_datetime <= '2021-06-20' "
            + " AND e.location_id = :location "
            + " GROUP  BY p.patient_id "
            + ") "
            + "GROUP BY p.patient_id ";
  ...
  public static String getPatientsTransferredInFromAnotherHFByEndOfReportingPeriod(
    ...
    String query =
        "SELECT results.patient_id FROM ( "
            ...
            + " AND e.encounter_datetime >= '2019-03-21'   "
            + " AND e.encounter_datetime <= '2021-06-20' "
            + " GROUP  BY p.patient_id "
            + ")results "
            + "UNION "
            ...
            + "AND ps.patient_state_id=${76} AND ps.end_date IS NULL AND ps.start_date<='2021-06-20' "
            + "AND pg.location_id= :location GROUP BY p.patient_id ";
  ...
  public static String getPatientsReInitiatedToPrEP(
    ...
    String query =
        " SELECT  p.patient_id "
            ...
            + "AND e.location_id = :location AND e.encounter_type=${80}  "
            + "AND e.encounter_datetime >= '2021-03-21'   "
            + "AND e.encounter_datetime <= '2021-06-20' "
            + "GROUP  BY p.patient_id ";
