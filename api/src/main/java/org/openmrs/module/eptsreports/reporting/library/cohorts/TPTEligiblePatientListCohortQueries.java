  ...
  public CohortDefinition getIPTB5Part1(
    ...
    String query =
        " SELECT p.patient_id   "
            ...
            + "           INNER JOIN obs oo2 "
            + "           ON         e2.encounter_id = oo2.encounter_id "
            + "           INNER JOIN "
            + "                      ( "
            ...
            + "                      AND        oo.value_coded = ${656} ) "
            + "           AND        ( "
            + "                                 oo2.concept_id = ${165308} "
            + "                      AND        oo2.value_coded IN ( ${1256}, ${1257} ) ) "
            + "           AND        e2.encounter_datetime <= :endDate "
            + "           AND        e2.encounter_datetime BETWEEN tabela.start_date AND date_add(tabela.start_date, INTERVAL 7 month) ) >= 5 "
            + "GROUP BY p.patient_id";
