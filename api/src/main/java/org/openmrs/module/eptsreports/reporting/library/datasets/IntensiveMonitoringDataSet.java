...
public class IntensiveMonitoringDataSet extends BaseDataSet {
  ...
  public DataSetDefinition constructIntensiveMonitoringDataSet() {
    ...
    //    dataSetDefinition.addColumn(
    //        "MI13DEN15",
    //        "% de MG elegíveis a CV com registo de pedido de CV feito pelo clínico (MG que
    ...
    //    dataSetDefinition.addColumn(
    //        "MI13DEN16",
    //        "% de MG elegíveis a CV com registo de pedido de CV feito pelo clínico na primeira CPN
    // (MG que entraram em TARV na CPN) Denominator:# de MG que tiveram a primeira CPN no período de
    // inclusão, e que já estavam em TARV há mais de 3 meses",
    //        EptsReportUtils.map(
    //            customCohortIndicator(
    ...
    //    dataSetDefinition.addColumn(
    //        "MI13DEN17",
    //        "% de MG que receberam o resultado da Carga Viral dentro de 33 dias após pedido
    // Denominator: # de MG com registo de pedido de CV no período de revisão",
    //        EptsReportUtils.map(
    //            customCohortIndicator(
    ...
    //    dataSetDefinition.addColumn(
    //        "MI13DEN2",
    //        "Adultos (15/+anos) que iniciaram a 1a linha de TARV ou novo regime da 1ª linha há 9
    // meses atrás",
    //        EptsReportUtils.map(
    //            customCohortIndicator(
    ...
    //    dataSetDefinition.addColumn(
    //        "MI13DEN10",
    //        "Crianças  (5-9 anos de idade) com registo de início da 1a linha de TARV ou novo
    // regime de TARV há 9 meses",
    //        EptsReportUtils.map(
    //            customCohortIndicator(
    ...
    //    dataSetDefinition.addColumn(
    //        "MI13DEN11",
    //        "Crianças  (10-14 anos de idade) com registo de início da 1a linha de TARV ou novo
    // regime da 1ª linha de TARV no mês de avaliação",
    //        EptsReportUtils.map(
    //            customCohortIndicator(
    ...
    //    dataSetDefinition.addColumn(
    //        "MI13NUM11",
    //        "Crianças (10-14 anos de idade) na 1a linha de TARV que receberam o resultado da Carga
    // Viral entre o sexto e o nono mês após o início do TARV",
    //        EptsReportUtils.map(
    //            customCohortIndicator(
    ...
    //    dataSetDefinition.addColumn(
    //        "MI13NUM14",
    //        "Crianças na 2a linha de TARV que receberam o resultado da CV entre o sexto e o nono
    // mês após início da 2a linha de TARV no mês de avaliação",
    //        EptsReportUtils.map(
    //            customCohortIndicator(
    ...
    //    /**
    //     * *********************************** MI CATEGORY 14 *********************
    //     * //********************* MI CAT14 Inherited from the MQCAT14 with adjusted date
    // parameters
    //     * **************
    //     */
