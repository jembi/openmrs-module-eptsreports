...
public class RMPREPQueries {
     ...
     * @return
     */
    public static String getA1(int prepInicialEncounterType,
                               int acceptStartMedicationConcept,
                               int yesConcept){
    ...
    public static String getB2(int prepInicialEncounterType,
     ...
     * @return
     */
    public static String getC1(int prepInicialEncounterType,
     ...
     * @return
     */
    public static String getD1(int prepInicialEncounterType,
                               int prepSeguimentoEncounterType,
                               int numberOfBottles,
                               int initialStatusPrep,
