...
public class ViralLoadQueries {
  ...
  public static String getPatientsHavingTypeOfDispensationBasedOnTheirLastVlResults(
    ...
    return ""
        ...
        + "                                  INNER JOIN (SELECT patient_id, "
        + "                                                    DATE( Max(encounter_date)) AS "
        + "                                                     vl_max_date "
        + "                                              FROM   (SELECT p.patient_id, "
        + " DATE(e.encounter_datetime) AS "
        + "encounter_date "
        + "FROM   patient p "
        ...
        + "AND o.value_numeric IS NOT "
        + "    NULL "
        + "AND DATE(o.obs_datetime) BETWEEN "
        + "    :startDate AND "
        + "    :endDate "
        + "AND e.location_id = 400) "
        + "max_vl_date "
        ...
        + "WHERE  ee.encounter_datetime BETWEEN Date_add( "
        + "vl_date_tbl.vl_max_date, "
