...
public class TPTCompletionDataSet extends BaseDataSet {
  ...
  public DataSetDefinition constructTPTCompletionDataSet() {
    ...
    String mappings4 = "startDate=${startDate},endDate=${endDate},location=${location}";
    ...
    CohortIndicator txCurrWithTPTinLast7Months =
        eptsGeneralIndicator.getIndicator(
            ...
            EptsReportUtils.map(
                tPTCompletionCohortQueries.getTxCurrWithTPTInLast7Months(), mappings4));
    ...
    dataSetDefinition.addColumn(
        ...
        EptsReportUtils.map(txCurrWithTPTCompIndicator, mappings2),
        "");
