  ...
  public static String getPatientHavingLastScheduledDrugPickupDate(
    ...
    String query =
        "SELECT final.patient_id "
            + "            FROM( "
            + "                SELECT   "
            + "                      most_recent.patient_id, Date_add(MAX(most_recent.value_datetime), interval ${numDays} day) final_value_date   "
            ...
            + "                              e.patient_id = fila.patient_id "
            + "                              "
            + "                    INNER JOIN obs o on "
            + "                              o.encounter_id = e.encounter_id "
            + "                              where e.encounter_datetime = fila.encounter_datetime and "
            + "                              e.encounter_type =  ${ARVPharmaciaEncounterType} and "
            + "                              e.location_id =   :location  and "
            + "                              e.voided = 0 and "
            + "                              e.encounter_datetime <= :onOrBefore  and "
            ...
            + ") "
            + "              most_recent GROUP BY most_recent.patient_id HAVING final_value_date <= :onOrBefore ) final ";
