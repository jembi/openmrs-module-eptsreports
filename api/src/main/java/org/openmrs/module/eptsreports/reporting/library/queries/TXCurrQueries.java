  ...
  public static String getPatientsWhoStoppedOrSuspendedTreatmentQuery(
    ...
    String query =
        "select suspended.patient_id from ( "
            ...
            + "      AND e.voided = 0 "
            + "      AND o.voided = 0 "
            + "      AND e.patient_id = suspended.patient_id "
            + "      AND e.encounter_datetime > suspended.suspended_date "
            + "      AND e.encounter_datetime <= :onOrBefore "
            + " )  "
            + "    GROUP BY suspended.patient_id";
  ...
  public static String getPatientsWhoAreDeadQuery(
    ...
    String query =
        "SELECT dead.patient_id FROM ( "
            ...
            + "                INNER JOIN obs o "
            + "                           ON o.encounter_id = e.encounter_id "
            + "    WHERE  e.encounter_type IN ( ${6}, ${18} ) "
            + "      AND e.voided = 0 "
            + "      AND o.voided = 0 "
            + "      AND e.patient_id = dead.patient_id "
            + "      AND e.encounter_datetime > dead.death_date "
            + "      AND e.encounter_datetime <= :onOrBefore "
            + " )  "
