...
public class SetupListOfPatientsDefaultersOrIITReport extends EptsDataExportManager {
    ...
    try {
      reportDesign =
          createXlsReportDesign(
              reportDefinition,
              "Template_List_Patients_Defaulters_IIT_TARV_v1.3.xls",
  ...
  public List<Parameter> getParameters() {
    return Arrays.asList(
        ...
        new Parameter("minDays", "Minimum Days of Absence", Date.class),
        new Parameter("maxDays", "Maximum days of Absence", Date.class),
