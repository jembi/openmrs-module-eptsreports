...
public class EriDSDCohortQueries {
  ...
  public CohortDefinition getCD4CountAndCD4Percent2() {
    ...
    cd.addSearch(
            ...
            EptsReportUtils.map(
            		getCD4CountAndCD4Percent2Part1(),
                "endDate=${endDate},location=${location}"));
  ...
  private  CohortDefinition getCD4CountAndCD4Percent2Part1() {
	    ...
	    cd.setName(
	        ...
	        map.put(
	            "6", hivMetadata.getAdultoSeguimentoEncounterType().getEncounterTypeId());
	        map.put(
	            "9",
	            hivMetadata.getPediatriaSeguimentoEncounterType().getEncounterTypeId());
	        map.put(
	            "13", hivMetadata.getMisauLaboratorioEncounterType().getEncounterTypeId());
	        ...
	        String query = "SELECT  cd4_max.patient_id " + 
	        		"FROM " + 
	        		"( " + 
