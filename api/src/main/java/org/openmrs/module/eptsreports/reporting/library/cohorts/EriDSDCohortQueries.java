...
public class EriDSDCohortQueries {
  ...
  public CohortDefinition getN7() {
    ...
    CohortDefinition nonPregnantNonBreastfeedingNotTB = getNonPregnantNonBreastfeedingAndNonTb();
    ...
    cd.addSearch(
        "nonPregnantNonBreastfeedingNotTB", mapStraightThrough(nonPregnantNonBreastfeedingNotTB));

    cd.setCompositionString("txCurr AND communityDispense AND nonPregnantNonBreastfeedingNotTB");
  ...
  public CohortDefinition getNonPregnantNonBreastfeedingAndNonTb() {
    CompositionCohortDefinition cd = new CompositionCohortDefinition();
    cd.addParameter(new Parameter("startDate", "Start Date", Date.class));
    cd.addParameter(new Parameter("endDate", "End Date", Date.class));
    cd.addParameter(new Parameter("location", "Location", Location.class));
    CohortDefinition pregnantBreastfeeding = getNonPregnantAndNonBreastfeeding();
    CohortDefinition tb = commonCohortQueries.getPatientsOnTbTreatment();
    cd.addSearch("nonPregnantAndNonBreastfeeding", mapStraightThrough(pregnantBreastfeeding));
    cd.addSearch("tb", mapStraightThrough(tb));
    cd.setCompositionString("nonPregnantAndNonBreastfeeding AND NOT tb");
    return cd;
  }
}
