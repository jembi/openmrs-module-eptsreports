  ...
  public static String getInhStartOnFilt() {
    return " SELECT     filt.patient_id, filt.start_date AS start_date "
        ...
        + "      o2.value_coded = ${1257} and o2.obs_datetime <= :endDate)  "
                ...
                + "      AND o2.voided = 0  "
                + "      AND e.location_id = :location  "
                + "      AND e.encounter_type = ${60} AND p.patient_id = e.patient_id  "
                + "      AND ( o.concept_id = ${23985}  "
                + "        AND o.value_coded IN ( ${656}, ${23982} ) )  "
                + "      AND (o2.concept_id = ${23987}  "
                + "      AND o2.value_coded IN (${1705}, ${1267}) "
        ...
        + "                    SELECT p.patient_id "
        + "                    from patient p "
        + "                             join encounter e2 on p.patient_id = e2.patient_id "
        + "                             join  obs o2 on e2.encounter_id = o2.encounter_id "
        + "                    where e2.encounter_type = 60 "
        + "                      and o2.concept_id = 23987 "
