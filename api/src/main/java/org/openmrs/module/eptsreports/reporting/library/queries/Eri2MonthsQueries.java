...
public class Eri2MonthsQueries {
  ...
  public static String getAllPatientsWhoReturnedFor2ndConsultationOR2ndDrugsPickUpWithin33Days(
    ...
    return "SELECT inicio_real.patient_id  "
        ...
        + "       AND e.encounter_datetime <= Date_add(inicio_real.data_inicio, INTERVAL 33 day))  "
        + "       OR (e.encounter_type = "
        + mastercardDrugPickupEncounterType
        + " AND o.concept_id = "
        + artPickupConcept
        ...
        + " AND pickup.concept_id = "
        + artPickupDateConcept
        + "       AND pickup.value_datetime > inicio_real.data_inicio "
        + "       AND pickup.value_datetime <= Date_add(inicio_real.data_inicio, INTERVAL 33 day)) ) "
