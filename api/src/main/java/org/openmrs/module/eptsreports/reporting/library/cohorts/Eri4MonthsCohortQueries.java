...
public class Eri4MonthsCohortQueries {
  ...
  public CohortDefinition
    ...
    Map<String, Integer>  map   = new  HashMap<>();
	  map.put("arvPharmaciaEncounter", hivMetadata.getARVPharmaciaEncounterType().getEncounterTypeId());
	  map.put("arvAdultoSeguimentoEncounter",   hivMetadata.getAdultoSeguimentoEncounterType().getEncounterTypeId());
	  map.put("arvPediatriaSeguimentoEncounter", hivMetadata.getPediatriaSeguimentoEncounterType().getEncounterTypeId());
	  ...
	  map.put("historicalDrugsConcept",  hivMetadata.getHistoricalDrugStartDateConcept().getConceptId());
