  ...
  public CohortDefinition getPregnantWithoutCd4() {
    ...
    String query =
        "SELECT pregnant.patient_id "
            ...
            + "                          AND o.value_datetime <= :inclusionStartDate "
            + "                          AND e.voided = 0 "
            + "                          AND o.voided = 0 "
            + "                   UNION "
            + "                   SELECT e.patient_id "
            ...
            + "                          AND e.encounter_datetime <= :inclusionStartDate "
            + "                          AND o.voided = 0 "
            + "                          AND e.voided = 0 "
            + "                   UNION "
            + "                   SELECT e.patient_id "
            ...
            + "                          AND ps.start_date <= :inclusionStartDate "
            + "                   UNION "
            + "                   SELECT e.patient_id "
            + "                   FROM   encounter e "
            + "                          INNER JOIN obs o "
            ...
            + "                          AND e.location_id = :location "
            + "                          AND (o2.concept_id = ${1190} "
            + "                          AND o2.value_datetime >= pregnant.pg_date "
            + "                          AND o2.value_datetime <= :inclusionStartDate )"
            + "                          AND e.voided = 0 "
            + "                          AND o.voided = 0 "
            + "                          AND o2.voided = 0 "
            + "                   UNION "
            ...
            + "                          AND Date(o2.value_datetime) <= :inclusionStartDate "
            + "                          AND e.voided = 0 "
            + "                          AND o.voided = 0 "
            + "                          AND o2.voided = 0 "
            + "                          AND e.location_id = :location "
