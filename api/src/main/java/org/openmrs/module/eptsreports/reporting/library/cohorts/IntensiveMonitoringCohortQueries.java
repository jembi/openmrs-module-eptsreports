...
public class IntensiveMonitoringCohortQueries {
   ...
   * <ul>
   *   <li>
   *       at least one Clinical Consultation (encounter type 6, encounter_datetime) or at least one ARV Pickup (encounter type 52, value_datetime(concept_id 23866)) between “Last Clinical Consultation” (encounter_datetime from A) minus 30 days and “Last Clinical Consultation” (encounter_datetime from A) minus 1 day
   *   </li>
   *   <li>
   *       at least one Clinical Consultation (encounter type 6, encounter_datetime) or at least one ARV Pickup (encounter type 52, value_datetime(concept_id 23866)) between “Last Clinical Consultation” (encounter_datetime from A) minus 60 days and “Last Clinical Consultation” (encounter_datetime from A) minus 31 days
   *   </li>
   *   <li>
   *       at least one Clinical Consultation (encounter type 6, encounter_datetime) or at least one ARV Pickup (encounter type 52, value_datetime(concept_id 23866)) between “Last Clinical Consultation” (encounter_datetime from A) minus 90 days and “Last Clinical Consultation” (encounter_datetime from A) minus 61 days
   *   </li>
   * </ul>
   *
   * @return CohortDefinition
   */
  public CohortDefinition getMI15E() {
    ...
    String query =
        ...
        + "                     AND e.voided = 0 "
        + "                     AND e.encounter_type = ${6} "
        + "                     AND e.encounter_datetime BETWEEN Date_sub((SELECT Max(e.encounter_datetime) "
        + "                         FROM  patient pp "
        + "                               INNER JOIN encounter e "
        + "                                       ON e.patient_id = pp.patient_id "
        + "                         WHERE pp.voided = 0 "
        ...
        + "                               AND e.location_id = :location "
        + "                               AND e.encounter_type = ${6} "
        + "                               AND e.encounter_datetime BETWEEN :startDate AND :endDate), INTERVAL 30 day) AND Date_sub( "
        + "                               (SELECT Max(e.encounter_datetime) "
        + "                                   FROM  patient pp "
        + "                                         INNER JOIN encounter e "
        + "                                                 ON e.patient_id = pp.patient_id "
        ...
        + "                                         AND e.location_id = :location "
        + "                                         AND e.encounter_type = ${6} "
        + "                                         AND e.encounter_datetime BETWEEN :startDate AND :endDate), INTERVAL 1 day) "
        + "UNION "
        ...
        + "       AND o.value_datetime BETWEEN Date_sub((SELECT Max(e.encounter_datetime) "
        + "           FROM  patient pp "
        + "                 INNER JOIN encounter e "
        + "                         ON e.patient_id = pp.patient_id "
        + "           WHERE pp.voided = 0 "
        ...
        + "                 AND e.location_id = :location "
        + "                 AND e.encounter_type = ${6} "
        + "                 AND e.encounter_datetime BETWEEN :startDate AND :endDate), INTERVAL 30 day) "
        + "                 AND Date_sub((SELECT Max(e.encounter_datetime) "
        + "                     FROM  patient pp "
        + "                           INNER JOIN encounter e "
        + "                                   ON e.patient_id = pp.patient_id "
        + "                     WHERE pp.voided = 0 "
        ...
        + "                           AND e.location_id = :location "
        + "                           AND e.encounter_type = ${6} "
        + "                           AND e.encounter_datetime BETWEEN :startDate AND :endDate), INTERVAL 1 day)) AS e1 "
        + "WHERE EXISTS ( "
        ...
        + "                 AND e.location_id = :location "
        + "                 AND e.encounter_type = ${6} "
        + "                 AND e.encounter_datetime BETWEEN :startDate AND :endDate), INTERVAL 60 day) "
        + "                 AND Date_sub((SELECT Max(e.encounter_datetime) "
        + "                     FROM  patient pp "
        + "                           INNER JOIN encounter e "
        + "                                   ON e.patient_id = pp.patient_id "
        ...
        + "                           AND e.location_id = :location "
        + "                           AND e.encounter_type = ${6} "
        + "                           AND e.encounter_datetime BETWEEN :startDate AND :endDate), INTERVAL 31 day) "
        + "UNION "
        + "SELECT p.patient_id, o.value_datetime "
        + "       FROM  patient p "
        + "             INNER JOIN encounter e "
        ...
        + "                 AND e.location_id = :location "
        + "                 AND e.encounter_type = ${6} "
        + "                 AND e.encounter_datetime BETWEEN :startDate AND :endDate), INTERVAL 90 day) "
        + "                 AND Date_sub((SELECT Max(e.encounter_datetime) "
        + "                 FROM  patient pp "
        + "                       INNER JOIN encounter e "
        + "                               ON e.patient_id = pp.patient_id "
        ...
        + "                       AND e.location_id = :location "
        + "                       AND e.encounter_type = ${6} "
        + "                       AND e.encounter_datetime BETWEEN :startDate AND :endDate), INTERVAL 61 day) "
        + "UNION "
        + "SELECT p.patient_id, o.value_datetime "
        + "FROM   patient p "
        + "       INNER JOIN encounter e "
