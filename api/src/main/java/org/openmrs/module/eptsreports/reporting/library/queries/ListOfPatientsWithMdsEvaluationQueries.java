...
public class ListOfPatientsWithMdsEvaluationQueries {
   ...
   * @return {@link String}
   */
  public String getPatientsActiveOnTarv(int abandonoMonths) {
    return "SELECT  final.patient_id, 'ACTIVO' "
        ...
        + new EptsQueriesUtil()
            .unionBuilder(getPatientsWhoAbandonedTarvQuery(false, abandonoMonths))
   ...
   * @return {@link String}
   */
  public String getPatientsWhoAbandonedTarvQuery(boolean isForDataDefinition, int abandonoMonths) {
    String fromSQL =
        "FROM     ( "
            + "         SELECT "
            + "             start.patient_id, "
