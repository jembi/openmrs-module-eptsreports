...
public class TPTEligiblePatientsQueries {
     ...
     * <li>
     * <p> 6: Select all patients with Outras prescricoes(concept id 1719) value coded DT-3HP (concept id
     * 165307) on Ficha clinica (encounter type 6)  by report end date;
     * </li>
     *
     * @return String
     */
    ...
    /**
     * <li>
     * 7: Select encounter datetime as FILT 3HP start date from
     * “Regime de TPT” (concept id 23985) with value coded “3HP”
     * or ” 3HP+Piridoxina” (concept id in [23954, 23984]) and
     * “Seguimento de tratamento TPT”(concept ID 23987) value coded
     * “inicio” or “re-inicio”(concept ID in [1256, 1705]) marked
     * on FILT (encounter type 60) and encounter datetime <= end date;
     * </li>
     *
     * @return String
     */
