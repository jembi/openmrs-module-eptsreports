...
public class TPTEligiblePatientsQueries {
   ...
   * <p>Y1: Select “Ultima profilaxia Isoniazida (Data Inicio)[value datetime]”
   * (concept id 6128) or Última profilaxia(concept id 23985) value coded INH
   * (concept id 656) and Data Início da Profilaxia TPT(value datetime, concept id 6128)
   * from  Ficha Resumo (encounter type 53) with   and value datetime not null
   * and <= end date. Or
   * </p>
   *<li>Note: if there is more than one Ficha Resumo then information from all Ficha Resumo should be included.</li>
   * @return {@link String}
   */
  ...
  /**
   * <b>K. Patients IPT Start Dates as:</b>
   * <p>Y2: Select Encounter Datetime from Ficha clinica (encounter type 6) with
   * “Profilaxia INH” (concept id 6122) with value code “Inicio” (concept id 1256)
   * or  Profilaxia TPT (concept id 23985) value coded INH (concept id 656) and Estado
   * da Profilaxia (concept id 165308) value coded Início (concept id 1256)  and encounter
   * datetime <= end date. or
   * </p>
   * @return {@link String}
   */
   ...
   * <b>K. Patients IPT Start Dates as:</b>
   * <p>
   *     Y3: Select value datetime from Ficha clinica or Ficha Pediatrica
   *     (encounter type 6,9) with “Profilaxia com  INH” (concept id 6128)
   *     and value datetime is not null and <= end date. or
   * </p>
   * @return {@link String}
   */
   ...
   * <b>K. Patients IPT Start Dates as:</b>
   * <p>
   *    Y4: Select Encounter Datetime from FILT (encounter type 60) with
   *    “Regime de TPT” (concept id 23985) value coded ‘Isoniazid’ or
   *    ‘Isoniazid + piridoxina’ (concept id in [656, 23982]) and encounter
   *    datetime <= end date.
   * </p>
   * @return {@link String}
   */
   ...
   * <b>K. Patients IPT Start Dates as:</b>
   * <p>
   *    Y5: Select encounter datetime with “Regime de TPT” (concept id 23985)
   *    value coded ‘Isoniazid’ or ‘Isoniazid + piridoxina’ (concept id in [656, 23982])
   *    and  “Seguimento de tratamento TPT”(concept ID 23987) value coded “inicio” or
   *    “re-inicio”(concept ID in [1256, 1705]) marked on FILT (encounter type 60) and
   ...
   * <b>K. Patients IPT Start Dates as:</b>
   * <p>
   *    Y6: Select encounter datetime from  FILT (encounter type 60) with “Regime de TPT”
   *    (concept id 23985) value coded ‘Isoniazid’ or ‘Isoniazid + piridoxina’
   *    (concept id in [656, 23982]) and “Seguimento de Tratamento TPT” (concept ID 23987)
   *    with values “Continua” (concept ID 1257) or no value(null) or concept 23987 does not
   *    exist and encounter datetime (as INH Start Date) between start date and end date and:
   *
   * </p>
   *
   * <li>
   *  No other INH values [Regime de TPT” (concept id 23985) value coded
   *  ‘Isoniazid’ or ‘Isoniazid + piridoxina’ (concept id in [656, 23982])]
   *  marked on FILT in the 7 months prior to ‘INH Start Date’; and
   *
   * </li
   *
   * <li>
   *  No Última profilaxia Isoniazida (Data Início) (Concept ID 6128, value_datetime)
   *  or Última profilaxia(concept id 23985) value coded INH(concept id 656) and Data Início
   *  da Profilaxia TPT(value datetime, concept id 6128)  not null  registered in Ficha Resumo
   *  - Mastercard (Encounter Type ID 53) in the 7 months prior to ‘INH Start Date’; and
   * </li>
   *
   * <li>
   *    No Profilaxia (INH) (Concept ID 6122) with the value “I” (Início) (Concept ID 1256)
   *    or  Profilaxia TPT (concept id 23985) value coded INH (concept id 656) and Estado da
   *    Profilaxia (concept id 165308) value coded Início (concept id 1256) marked on Ficha Clínica
   *    - Mastercard (Encounter Type ID 6)  in the 7 months prior to ‘INH Start Date’; and
   * </li>
   *
   * <li>
   *
   *     No Profilaxia com INH – TPI (Data Início) (Concept ID 6128, value_datetime) marked in
   *     Ficha de Seguimento (Adulto e Pediatria) (Encounter Type ID 6,9) in the 7 months prior
   *     to ‘INH Start Date’
   * </li>
   * @return {@link String}
   */
