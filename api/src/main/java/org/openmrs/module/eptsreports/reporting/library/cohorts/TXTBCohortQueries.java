...
public class TXTBCohortQueries {
  ...
  public CohortDefinition getPatientsTransferredOut() {
    ...
    //TODO: REFACTOR THIS IMPLEMENTATION TO RUN FASTER
    String query =
        "SELECT   transferred_out.patient_id "
            + "             FROM     ( "
            + "                                 SELECT     latest.patient_id , "
            + "                                            Max(latest.last_date) AS last_state_date "
            + "                                 FROM       ( "
            + "                                                       SELECT     p.patient_id , "
            ...
            + "                                                       AND        e.encounter_datetime > latest.last_date "
  ...
  private String getLastStateOfStayOnSources() {
    return " SELECT     last.patient_id , "
        + "                                            Max(last.last_date) AS last_date "
        + "                                 FROM       ( "
        + "                                                       SELECT     p.patient_id , "
        + "                                                                  Max(ps.start_date) AS last_date "
        + "                                                       FROM       patient p "
