...
public class TPT_InitiationQueries {
  ...
  public static String getTPTInitiationPatients(
    ...
    valuesMap.put("6129", dataFinalizacaoProfilaxiaIsoniazidaConcept);
        ...
        + "                    AND e.encounter_type in (${5},${6}) AND e.encounter_datetime between :startDate AND :endDate AND e.location_id=:location AND pe.gender='F' GROUP BY p.patient_id   "
        + "                     "
        + "                    UNION   "
        ...
        + "                    and   "
        + "                    e.encounter_type in (${5}, ${6}) AND e.encounter_datetime between :startDate AND :endDate AND e.location_id=:location  AND pe.gender='F' GROUP BY p.patient_id   "
        + "                    UNION   "
        + "                     "
        + "                     "
        + "                    Select p.patient_id,  MAX(e.encounter_datetime) as pregnancy_date   "
