...
public class TPT_InitiationQueries {
  ...
  public static String getTPTInitiationPatients(int clinicalEncounter) {
    ...
    //    String query =
    return "  SELECT p.person_id, pi.identifier AS NID, p.gender, CONCAT(pn.given_name, ' ', pn.family_name ) AS name, "
        + "CASE  "
        + "WHEN p.birthdate IS NULL THEN 'N/A' "
        + "ELSE TIMESTAMPDIFF(YEAR,p.birthdate,'2020-04-20') "
        + "END AS age, "
        + "initiated_art.first_pickup AS tarv_date, "
        + "CASE "
        ...
        + "CASE  "
        + "WHEN received_TPT.followup_date IS NULL THEN 'Não' "
        + "ELSE 'Sim' "
        + "END AS received_TPT, "
        ...
        + "                              AND e.encounter_datetime >= '2020-01-21' "
        + "                              AND e.encounter_datetime <= '2020-04-20' "
        ...
        + "AND p.voided = 0 AND e.location_id = 398 "
        + "AND o.value_datetime IS NOT NULL "
        + "AND o.value_datetime BETWEEN '2020-01-21' AND '2020-04-21' "
        + " "
        + "UNION "
        + " "
        + "SELECT p.patient_id FROM patient p  "
        ...
        + "AND e.encounter_datetime BETWEEN '2020-01-21' AND '2020-04-21' "
        + " "
        + "UNION "
        + " "
        + "SELECT p.patient_id FROM patient p  "
        ...
        + "AND o.voided = 0 AND e.location_id = 398 "
        ...
        + "AND e.voided = 0 AND p.voided = 0 "
        + "AND o.voided = 0 AND e.location_id = 398  "
        + "AND e.encounter_datetime <= '2020-01-21') arv_plan  "
        ...
        + "    WHERE e.encounter_type = 52 AND e.location_id = 398 "
        + "    AND e.voided = 0 AND p.voided = 0 "
        + "    AND o.concept_id =  23866 AND o.voided =0 "
        + "    AND o.value_datetime <= '2020-04-20' "
        + "    GROUP BY p.patient_id "
        + "     "
        + "UNION "
        + " "
        ...
        + "AND pp.date_enrolled <= '2020-04-20' "
        + "AND p.voided = 0 "
        ...
        + "                    AND e.encounter_type in (5,6) AND e.encounter_datetime between '2020-01-21' AND '2020-02-20' AND e.location_id=398 AND pe.gender='F' GROUP BY p.patient_id   "
        + "                     "
        + "                    UNION   "
        ...
        + "                AND historical_date.value_datetime between '2020-01-21' AND '2020-02-20' AND e.location_id=398 AND pe.gender='F' GROUP BY p.patient_id   "
        + "                 "
        + "                 "
        + "                    UNION   "
        + "                    SELECT p.patient_id,  MAX(e.encounter_datetime) as pregnancy_date   "
        ...
        + "                    and   "
        + "                    e.encounter_type in (5, 6) AND e.encounter_datetime between '2020-01-21' AND '2020-02-20' AND e.location_id=398  AND pe.gender='F' GROUP BY p.patient_id   "
        + "                    UNION   "
        + "                     "
        + "                     "
        + "                    Select p.patient_id,  MAX(e.encounter_datetime) as pregnancy_date   "
        ...
        + "                    AND pp.voided=0 AND pp.date_enrolled between  '2020-01-21' AND '2020-02-20' AND pp.location_id=398 AND pe.gender='F' GROUP BY pp.patient_id   "
        + "                    UNION "
        + "                     "
        ...
        + "                    AND e.encounter_type = 6 "
        + "                    AND pe.gender='F' AND o.value_datetime BETWEEN '2020-01-21' AND '2020-02-20' GROUP BY p.patient_id) as pregnant   "
        ...
        + "                     AND  e.encounter_type in (5,6)  AND o.value_datetime BETWEEN '2020-01-21' AND '2020-02-20'    "
        ...
        + "       AND e.encounter_datetime BETWEEN '2020-01-21' AND '2020-02-20'   "
        + "          AND e.location_id=398 AND pe.gender='F'   "
        + "                     GROUP BY p.patient_id  "
        + "                      "
        + "                     UNION   "
        ...
        + "                     AND ps.state=  27 "
        + "                     AND pp.voided=0 AND    "
        + "        ps.start_date BETWEEN '2020-01-21' AND '2020-02-20'    "
        ...
        + "       AND hist.value_datetime BETWEEN '2020-01-21' AND '2020-02-20'    "
        + "               GROUP BY p.patient_id   "
        + "                     ) AS breastfeeding   "
        ...
        + "JOIN encounter e ON e.patient_id = p.patient_id "
        + "WHERE e.encounter_type = 6 AND e.location_id = 398 "
        + "AND e.voided = 0 AND p.voided = 0 "
        ...
        + "( "
        + "SELECT "
        + "    p.patient_id, last_fu_consultation.followup_date as followup_date "
        + "FROM "
        + "    patient p "
        + "    JOIN encounter e ON e.patient_id = p.patient_id "
        + "    JOIN obs o ON o.encounter_id = e.encounter_id "
        ...
        + "AND o.value_coded IN (23954,23954) "
        + "AND e.encounter_datetime < curdate() "
        + "UNION  "
        + "SELECT "
        + "    p.patient_id, last_fu_consultation.followup_date as followup_date "
        ...
        + "SELECT "
        + "    p.patient_id, "
        + "    MAX(e.encounter_id) AS encounter_datetime "
        + "FROM "
        + "    patient p "
        + "        INNER JOIN "
        + "    encounter e ON p.patient_id = e.patient_id "
        ...
        + "( "
        + "SELECT  "
        + "p.patient_id, o.value_coded AS dispensation_type FROM patient p "
        + "JOIN  "
        + "encounter e ON e.patient_id = p.patient_id "
        + "JOIN obs o ON o.encounter_id = e.encounter_id "
        + "JOIN "
        + "(SELECT "
        + "    p.patient_id, MAX(e.encounter_datetime) AS recent_filt "
        + "FROM "
        + "    patient p "
        + "        INNER JOIN "
        + "    encounter e ON p.patient_id = e.patient_id "
        ...
        + "        WHERE "
        + "        latest_filt.recent_filt = e.encounter_datetime "
        + "        AND o.concept_id = 23986  "
        + "        AND o.value_coded IN (1098,23720) "
        + ") AS FILT_3HP_dispensation "
        + "ON FILT_3HP_dispensation.patient_id = p.person_id "
        + " "
        + "LEFT JOIN  "
        + "( "
        + "SELECT "
        + "    p.patient_id, MIN(e.encounter_datetime) AS pickup_date "
        + "FROM "
        + "    patient p "
        + "        INNER JOIN "
        + "    encounter e ON p.patient_id = e.patient_id "
        ...
        + " ( "
        + " SELECT "
        + "    p.patient_id, MIN(e.encounter_datetime) AS initiation_date "
        + "FROM "
        + "    patient p "
        + "        INNER JOIN "
        + "    encounter e ON p.patient_id = e.patient_id "
        ...
        + "        AND e.encounter_datetime BETWEEN '2020-01-21' AND '2020-04-20' "
        + "GROUP BY p.patient_id "
        + " ) AS IPT_clinical_seg_initiation  "
        ...
        + "    INNER JOIN obs o ON e.encounter_id = o.encounter_id "
        + "    WHERE "
        + "        e.encounter_type = 53 AND p.voided = 0 "
        + "            AND e.voided = 0 "
        + "            AND o.voided = 0 "
        + "            AND o.value_datetime IS NOT NULL "
        + "            AND o.concept_id = 6128 "
        + "            AND e.location_id = 398 "
        + "            AND o.value_datetime BETWEEN '2020-01-20' AND  '2019-11-21' "
        + "    GROUP BY p.patient_id "
        + " )IPT_mastercard_initiation  "
        ...
        + "    GROUP BY p.patient_id "
        + " ) FILT_with_IPT  "
        + " ON FILT_with_IPT.patient_id = p.person_id "
        + "  "
        + " LEFT JOIN  "
        + " ( "
        + " SELECT "
        ...
        + "        ON latest_filt.patient_id = p.patient_id "
        + "        WHERE "
        + "        latest_filt.encounter_datetime = e.encounter_datetime "
        ...
        + " ( "
        + " SELECT  "
        + "        fila.patient_id, MAX(fila.encounter_datetime) AS encounter_datetime "
        + "    FROM "
        + "        (SELECT  "
        ...
        + "            AND o.value_coded =1267 AND e.location_id = 398 "
        + "            AND e.encounter_datetime <= CURDATE() "
        + "            UNION  "
        + "             "
        ...
        + "            AND o.concept_id = 6129 AND e.location_id = 398 "
        ...
        + " "
        + "(SELECT "
        + "    p.patient_id, MIN(e.encounter_datetime) AS consultation_date "
        + "FROM "
        + "    patient p "
        + "        INNER JOIN "
        + "    encounter e ON p.patient_id = e.patient_id "
        ...
        + " "
        + "SELECT  "
        + "        p.patient_id, MAX(e.encounter_datetime) AS consultation_date "
        + "    FROM "
        + "        patient p "
        + "    INNER JOIN encounter e ON e.patient_id = p.patient_id "
        + "    INNER JOIN obs o ON e.encounter_id = o.encounter_id "
