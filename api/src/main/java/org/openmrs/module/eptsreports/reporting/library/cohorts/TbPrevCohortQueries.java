  ...
  public CohortDefinition getPatientsTransferredOut() {
    ...
    String query =
        "SELECT "
            ...
            + "  ) transferred_out "
            + "WHERE "
            + " transferred_out.patient_id NOT IN ( "
            + "    SELECT "
            + "      p.patient_id "
            + "    FROM "
            + "      patient p "
            ...
            + "      p.voided = 0 "
            + "      AND e.voided = 0 "
            + "      AND p.patient_id = transferred_out.patient_id "
            + "      AND e.encounter_type = ${18} "
            + "      AND e.encounter_datetime > transferred_out.last_date "
            ...
            + "          Max(last_next_pick_up.result_value) AS max_datetime "
            + "        FROM "
            + "          ( "
            + "            SELECT "
            + "              p.patient_id, "
            ...
            + "                SELECT "
            + "                  p.patient_id, "
            + "                  Max(e.encounter_datetime) AS e_datetime "
            + "                FROM "
            + "                  patient p "
            + "                  INNER JOIN encounter e ON p.patient_id = e.patient_id "
            + "                WHERE "
            ...
            + "    WHERE "
            + "      last_next_scheduled_pick_up.max_datetime BETWEEN :startDate AND :endDate "
            + "  ) "
