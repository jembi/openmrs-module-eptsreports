  ...
  public CohortDefinition getBreastfeedingPatients() {
    ...
    String query =
        "SELECT breastfeeding.patient_id FROM( "
            ...
            + "               vl.last_date AS last_vl, MAX(bf.breastfeeding_date) as bf_date "
            + "        FROM "
            ...
            + "                WHERE bf.patient_id IS NOT NULL AND bf.breastfeeding_date IS NOT NULL "
            + "                AND bf.breastfeeding_date BETWEEN DATE_SUB(vl.last_date, INTERVAL 18 MONTH) AND vl.last_date "
