...
public class NextAndPrevDatesCalculation extends AbstractPatientCalculation {
    ...
    public CalculationResultMap evaluate(
        ...
        for (Integer pId : cohort) {
            ...
            if (lastEncounter != null) {
                ...
                Encounter anotherLastEncounter = getAnotherLastEncounter(lastEncounter.getEncounterDatetime(),
            ...
            scheduled = compareAgainstBoundaries(lastEncounter, lastReturnVisitObs, lowerBound, upperBound);
    ...
    private Encounter getAnotherLastEncounter(Date onOrAfter, Date onOrBefore, Location location, Encounter encounter, Integer patientId, PatientCalculationContext context) {
        ...
        CalculationResultMap encounterMap =
                EptsCalculationUtils.evaluateWithReporting(def, Arrays.asList(patientId), null, null, context);
        ...
        if(lastEncounters.size()>0) {
            ...
            if (otherLastEncounter != null && otherLastEncounter.getEncounterId() != encounter.getEncounterId()) {
    ...
    private boolean compareAgainstBoundaries(Encounter lastEncounter, Obs lastReturnVisitObs, Integer lowerBound, Integer upperBound) {
