...
public class TPTInitiationDataDefinitionQueries {
     ...
     *
     * <p>
     * Set value equal to “Sim” if the patient received TPT in the last follow-up consultation Date (field 7 date) as following otherwise set “Não”:</p>
     * <ul>
     *    <li>if patient have Ficha Clinica (encounter type 6) with “Outras Prescricoes” (concept id 1719) value coded “3HP” (concept id 23954) or “DT-INH” (concept id 23955)
     *    in the last follow up consultation date before the report generation date (same as field 7)
     *    </li>
     *
     *    <li>
     *       If patient have Ficha Clinica (encounter_type 6) with “Profilaxia (INH)” (concept id 6122) value coded “Inicio” (concept id 1256)
     *       or “Continua” (concept id 1257) in the last follow up consultation date before the report generation date (same as field 7)
     *    </li>
     *
     *    <li>
     *        Select all patients with Ficha Clinica (encounter type 6) with “Profilaxia com INH - TPI (Data Inicio)”
     *        (Concept 6128) in the last follow up consultation date before the reporting end date
     *    </li>
     * </ul>
     * </p>
     *
