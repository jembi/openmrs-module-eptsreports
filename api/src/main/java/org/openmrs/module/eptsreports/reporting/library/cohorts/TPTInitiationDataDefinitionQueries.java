...
public class TPTInitiationDataDefinitionQueries {
  ...
  public DataDefinition get3HPInitiationDateOnFichaResumo() {
    ...
    String query =
        "SELECT p.patient_id, "
            ...
            + "         WHEN o2.concept_id = ${23985} "
            + "              AND o3.concept_id = ${165308} THEN Min(e.encounter_datetime) "
  ...
  public DataDefinition getExpected3HPCompletionDate() {
    ...
    String query =
        "SELECT last.patient_id, DATE_ADD(min(last.first_pickup_date), INTERVAL 86 DAY) as expected_date FROM ( "
            ...
            + "                                                                                                                                      Date_sub(pickup.first_pickup_date, "
            + "                                                                                                                                               interval 4 month) "
            + "                                                                                                                                  AND e.encounter_datetime < "
            + "                                                                                                                                      pickup.first_pickup_date "
            + "                                                                                                                                UNION "
            + "                                                                                                                                SELECT p.patient_id "
            + "                                                                                                                                FROM   patient p "
            + "                                                                                                                                           inner join encounter e "
