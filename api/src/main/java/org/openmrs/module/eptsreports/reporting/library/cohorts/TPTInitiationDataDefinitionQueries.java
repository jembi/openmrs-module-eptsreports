...
public class TPTInitiationDataDefinitionQueries {
   ...
   * <blockquote>
   *
   * <p>The earliest 3HP initiation date (obs_datetime for 165308) on Ficha Clinica - Master Card
   * (encounter type 6) with TPT (concept id 23985) value coded 3HP (concept id 23954) and Estado da
   ...
   * <blockquote>
   *
   * <p>The earliest 3HP Initiation date(obs datetime for 165308) registered in Ficha Resumo –
   * Mastercard (encounter type 53) with Última profilaxia(concept id 23985) value coded 3HP(concept
   * id 23954) and Data Início (concept 165308 value 1256) that falls during the reporting period
   * (TPT_INI_FR4).
   *
  ...
  public DataDefinition get3HPCompletionDateFichaClínica() {
    ...
    String query =
        "SELECT p.patient_id, "
            ...
            + "                   INNER JOIN ( "
            + "                          SELECT patient_id, MIN(tpt_start) AS earliest_date "
            + "                          FROM ( "
            + threeHPStart
            + ") threeHP "
  ...
  public DataDefinition get3HPCompletionDateonFichaResumo() {
    ...
    String query =
        "SELECT     p.patient_id, "
            ...
            + "           ( "
            + "               SELECT     p.patient_id, "
            + "                          Min(o.obs_datetime) AS earliest_date "
            + "               FROM       patient p "
            + "                              INNER JOIN encounter e "
            + "                                         ON         p.patient_id = e.patient_id "
            + "                              INNER JOIN obs o "
            ...
            + "                              UNION "
            + "                              SELECT     p.patient_id, "
            + "                                         filt.start_date AS earliest_date "
            + "                              FROM       patient p "
            + "                                             INNER JOIN "
            + "                                         ( "
            + "                                             SELECT     p.patient_id, "
            ...
            + "                                                             AND        o2.value_coded = ${1256} "
            + "                                                             AND        o2.obs_datetime >= Date_sub(filt.start_date, INTERVAL 4 month) "
            + "                                                             AND        o2.obs_datetime < filt.start_date ) ) ) ) AS 3hpfilt "
            + "                          ON         3hpfilt.patient_id = p.patient_id "
            + "               WHERE      p.voided = 0 "
            + "                 AND        e.voided = 0 "
            + "                 AND        o.voided = 0 "
            + "                 AND        o2.voided = 0 "
            ...
            + "                                      AND        o2.value_coded IN ( ${1256} , "
            + "                                                                     ${1705} ) ) "
            + "                   AND        o.obs_datetime BETWEEN 3hpfilt.earliest_date AND        :endDate ) "
            + "               GROUP BY   p.patient_id "
            + "               UNION "
            + "               SELECT     p.patient_id, "
            + "                          min(o2.obs_datetime) AS earliest_date "
            ...
            + "                              UNION "
            + "                              SELECT     p.patient_id, "
            + "                                         filt.earliest_date AS earliest_date "
            + "                              FROM       patient p "
            + "                                             INNER JOIN "
            + "                                         ( "
            + "                                             SELECT     p.patient_id, "
            ...
            + "                                        AND        o.value_coded IN ( ${23954}, "
            + "                                                                      ${23984} ) "
            + "                                        AND        e.encounter_datetime >= date_sub(filt.earliest_date, INTERVAL 4 month) "
            + "                                        AND        e.encounter_datetime < filt.earliest_date ) "
            + "                                AND        NOT EXISTS "
            + "                                  ( "
            + "                                      SELECT     pp.patient_id "
            + "                                      FROM       patient pp "
            ...
            + "                                                                   o2.concept_id = ${165308} "
            + "                                                               AND        o2.value_coded = ${1256} "
            + "                                                               AND        o2.obs_datetime >= date_sub(filt.earliest_date, INTERVAL 4 month) "
            + "                                                               AND        o2.obs_datetime < filt.earliest_date ) ) "
            + "                                          OR         ( "
            + "                                                                 o3.concept_id = ${1719} "
            + "                                                             AND        o3.value_coded = ${165307} ) ) ) "
            + "                                AND        NOT EXISTS "
            ...
            + "                                                             AND        o2.value_coded = ${1256} "
            + "                                                             AND        o2.obs_datetime >= date_sub(filt.earliest_date, INTERVAL 4 month) "
            + "                                                             AND        o2.obs_datetime < filt.earliest_date ) ) ) ) AS 3hpclinc "
            + "                          ON         3hpclinc.patient_id = p.patient_id "
            + "               WHERE      p.voided = 0 "
            + "                 AND        e.voided = 0 "
            + "                 AND        o.voided = 0 "
            + "                 AND        o2.voided = 0 "
            ...
            + "                                          o2.concept_id = ${165308} "
            + "                                      AND        o2.value_coded = ${1256} "
            + "                                      AND        o2.obs_datetime BETWEEN 3hpclinc.earliest_date AND        :endDate ) ) "
            + "               GROUP BY   p.patient_id "
            + "               UNION "
            + "               SELECT     p.patient_id, "
            + "                          min(o2.obs_datetime) AS earliest_date "
            ...
            + "                                                             AND        o2.value_coded = ${1256} "
            + "                                                             AND        o2.obs_datetime >= date_sub(filt.earliest_date, INTERVAL 4 month) "
            + "                                                             AND        o2.obs_datetime < filt.earliest_date ) ) ) ) AS 3hpresumo "
            + "                          ON         3hpresumo.patient_id = p.patient_id "
            + "               WHERE      p.voided = 0 "
            + "                 AND        e.voided = 0 "
            + "                 AND        o.voided = 0 "
            + "                 AND        o2.voided = 0 "
            ...
            + "                                          o2.concept_id = ${165308} "
            + "                                      AND        o2.value_coded = ${1256} "
            + "                                      AND        o2.obs_datetime BETWEEN 3hpresumo.earliest_date AND        :endDate ) ) "
            + "               GROUP BY   p.patient_id ) 3hp "
            + "           ON         3hp.patient_id = p.patient_id "
            + "WHERE      p.voided = 0 "
            + "  AND        e.voided = 0 "
            + "  AND        o.voided = 0 "
            + "  AND        o2.voided = 0 "
            ...
            + "                       AND        o2.obs_datetime BETWEEN 3hp.earliest_date AND        CURRENT_DATE() ) ) "
            + "GROUP BY   p.patient_id";
  ...
  public DataDefinition getPatientsAndIPTInitiationDateOnFilt() {
    ...
    String query =
        "SELECT     p.patient_id, "
            ...
            + "                                                 AND    o2.obs_datetime >= Date_sub(filt.start_date, INTERVAL 7 month) "
            + "                                                 AND    o2.obs_datetime < filt.start_date ) ) ) "
            + "               GROUP BY   p.patient_id) AS INHFilt "
            + "               ON INHFilt.patient_id = p.patient_id  "
            + "WHERE      p.voided = 0 "
            + "  AND        e.voided = 0 "
            + "  AND        o.voided = 0 "
            + "  AND        e.encounter_type = ${60} "
            ...
            + "  AND        e.encounter_datetime BETWEEN INHFilt.start_date AND        :endDate "
            + "GROUP BY   p.patient_id";
  ...
  public DataDefinition getPatientsAndIPTInitiationDateOnFichaClinicaOrFichaSeguimento() {
    ...
    String query =
        "SELECT     p.patient_id, "
            ...
            + "                                                          AND    o2.obs_datetime >= date_sub(filt.start_date, INTERVAL 7 month) "
            + "                                                          AND    o2.obs_datetime < filt.start_date ) ) ) "
            + "                      GROUP BY   p.patient_id) AS INHClinica "
            + "							ON INHClinica.patient_id = p.patient_id "
            + "WHERE      p.voided = 0 "
            + "AND        e.voided = 0 "
            + "AND        o.voided = 0 "
            + "AND        o2.voided = 0 "
            ...
            + "                                 o2.concept_id = ${165308} "
            + "                      AND        o2.value_coded = ${1256} "
            + "                      AND        o2.obs_datetime BETWEEN INHClinica.start_date AND        :endDate ) ) "
            + "GROUP BY   p.patient_id";
  ...
  public DataDefinition getPatientsAndIPTInitiationDateOnFichaResumo() {
    ...
    String query =
        "SELECT     p.patient_id, "
            ...
            + "                                                          AND    o2.obs_datetime >= date_sub(filt.start_date, INTERVAL 7 month) "
            + "                                                          AND    o2.obs_datetime < filt.start_date ) ) ) "
            + "                      GROUP BY   p.patient_id) AS inhresumo "
            + "ON         inhresumo.patient_id = p.patient_id "
            + "WHERE      p.voided = 0 "
            + "AND        e.voided = 0 "
            + "AND        o.voided = 0 "
            + "AND        o2.voided = 0 "
            ...
            + "                                 o2.concept_id = ${165308} "
            + "                      AND        o2.value_coded = ${1256} "
            + "                      AND        o2.obs_datetime BETWEEN inhresumo.start_date AND        :endDate ) ) "
            + "GROUP BY   p.patient_id";
  ...
  public DataDefinition getPatientsAndIPTCompletioDateOnFichaClinicaOrFichaSeguimento() {
    ...
    String query =
        "SELECT     p.patient_id, "
            + "           Max(o2.obs_datetime) AS recent_date "
            + "FROM       patient p "
            + "               INNER JOIN encounter e "
            + "                          ON         e.patient_id = p.patient_id "
            + "               INNER JOIN obs o "
            ...
            + "                                      AND        o2.value_coded = ${1256} "
            + "                                      AND        o2.obs_datetime BETWEEN inhresumo.start_date AND        :endDate ) ) "
            + "               GROUP BY   p.patient_id ) AS ipt "
            + "           ON         ipt.patient_id = p.patient_id "
            + "WHERE      p.voided = 0 "
            + "  AND        e.voided = 0 "
            + "  AND        o.voided = 0 "
            + "  AND        o2.voided = 0 "
            ...
            + "                           o2.concept_id = ${165308} "
            + "                       AND        o2.value_coded = ${1267} "
            + "                       AND        o2.obs_datetime BETWEEN ipt.pickup_date AND        CURRENT_DATE()) ) "
            + "GROUP BY   p.patient_id";
   ...
   * <blockquote>
   *
   * <p>The most recent Última profilaxia(concept id 23985) value coded INH(concept id 656) and Data
   * Fim (concept 165308 value 1267) selected in Ficha Resumo – Mastercard (Encounter Type 53)
