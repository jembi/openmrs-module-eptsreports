...
public class TPTInitiationDataDefinitionQueries {
  ...
  public DataDefinition getExpected3HPCompletionDate() {
    ...
    String query =
            "SELECT   patient_id, "
                    + "         Date_add(Min(earliest_date), INTERVAL 86 day) AS expected_date "
                    + "FROM     ( "
                    + "             SELECT     p.patient_id, "
                    + "                        Min(o.obs_datetime) AS earliest_date "
                    + "             FROM       patient p "
                    ...
                    + "                                    AND        o2.value_coded = ${1256} "
                    + "                                    AND        o2.obs_datetime BETWEEN 3hpresumo.earliest_date AND        :endDate ) ) "
                    + "             GROUP BY   p.patient_id ) union_tb "
                    + "GROUP BY union_tb.patient_id";
  ...
  public DataDefinition getDifferencebetweenRegisteredvsExpected3HPCompletionDate() {
    ...
    String query =
            "SELECT     p.patient_id, "
            + "           Datediff(Max(union_tbl.completion_date), tbl_17.datediff) AS result "
            + "FROM       patient p "
            + "               INNER JOIN "
            + "           ( "
            + "               SELECT     p.patient_id, "
            ...
            + "           ( "
            + "               SELECT   patient_id, "
            + "                        date_add(min(earliest_date), INTERVAL 86 day) AS datediff "
            + "               FROM     ( "
            + "                            SELECT     p.patient_id, "
            + "                                       min(o.obs_datetime) AS earliest_date "
            + "                            FROM       patient p "
            ...
            + "                                                   AND        o2.obs_datetime BETWEEN 3hpresumo.earliest_date AND        :endDate ) ) "
            + "                            GROUP BY   p.patient_id ) union_tb "
            + "               GROUP BY union_tb.patient_id ) tbl_17 "
  ...
  public DataDefinition getPatientsAndIPTCompletionDateAndIPTStartDatePlus173Days() {
    ...
    String query =
            "SELECT   patient_id, "
                    + "         Date_add(Max(pickup_date), INTERVAL 173 day) AS expected_date "
                    + "FROM     ( "
                    + "             SELECT     p.patient_id, "
                    + "                        Min(e.encounter_datetime) AS pickup_date "
                    + "             FROM       patient p "
  ...
  public DataDefinition
    ...
    String query =
            "SELECT     p.patient_id, "
            + "           Datediff(Max(union_tbl.recent_date), tbl_22.datediff) AS result "
            + "FROM       patient p "
            + "               INNER JOIN "
            + "           ( "
            + "               SELECT     p.patient_id, "
            ...
            + "           ( "
            + "               SELECT   patient_id, "
            + "                        date_add(max(pickup_date), INTERVAL 173 day) AS datediff "
            + "               FROM     ( "
            + "                            SELECT     p.patient_id, "
            + "                                       min(e.encounter_datetime) AS pickup_date "
            + "                            FROM       patient p "
            ...
            + "                                                   AND        o2.obs_datetime BETWEEN inhresumo.start_date AND        :endDate ) ) "
            + "                            GROUP BY   p.patient_id ) union_tbl "
            + "               GROUP BY patient_id ) tbl_22 "
            + "           ON         tbl_22.patient_id = p.patient_id "
            + "GROUP BY   p.patient_id";
