  ...
  public CohortDefinition getSecondPartFromITT() {
    ...
    String query =
        "SELECT final.patient_id  "
            ...
            + "    AND        o1.voided=0  "
            + "    AND        (o1.concept_id != ${1410} OR (o1.concept_id =${1410} AND o1.value_datetime IS NULL)) "
            + " "
            ...
            + "    AND        e1.encounter_datetime<= :onOrBefore  "
            + "    AND        e1.voided=0  "
            + "    AND        e1.encounter_type = ${18} "
            + "    AND        e1.location_id= :location  "
            + "    AND        o1.voided=0  "
            + "    AND        (o1.concept_id != ${5096} OR (o1.concept_id =${5096} AND o1.value_datetime IS NULL))  "
            + "    AND        o1.location_id =  :location) AS final  "
            + "                            ";
