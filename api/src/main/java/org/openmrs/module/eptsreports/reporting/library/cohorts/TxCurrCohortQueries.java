  ...
  public CohortDefinition getPatientsWithLessThan3MonthlyTypeOfDispensation() {
    ...
    String sqlQuery =
        "SELECT   en.patient_id              "
            ...
            + "             AND DATE(e.encounter_datetime) <= '2020-01-20'              "
            ...
            + "                     AND o.concept_id = 5096             "
            + "                     AND DATE(ex.encounter_datetime) <= '2020-01-20'             "
            ...
            + "                 AND DATE(list.encounter_datetime) <= '2020-01-20'             "
            + "                 AND list.voided = 0             "
  ...
  public SqlCohortDefinition getPatientsWithQuarterlyTypeOfDispensation() {
    ...
    String sqlQuery =
        "SELECT    en.patient_id      "
            ...
            + "   "
            + "         WHERE DATE(e.encounter_datetime) <= '2020-01-20'  "
            + " AND e.location_id = 208  "
            + " AND e.voided = 0  "
            + "                 AND e.encounter_type = 18  "
            + "                 AND e.patient_id = en.patient_id  "
