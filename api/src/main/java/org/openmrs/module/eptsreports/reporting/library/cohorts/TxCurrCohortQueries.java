  ...
  public CohortDefinition getPatientsWithLessThan3MonthlyTypeOfDispensation() {
    ...
    String sqlQuery =
        "SELECT   en.patient_id              "
            ...
            + "                     AND ex.location_id = 208) AS same_day             "
            + "         WHERE             "
            ...
            + "                 AND list.encounter_datetime <= '2020-01-20'             "
            + "                 AND list.voided = 0             "
  ...
  public SqlCohortDefinition getPatientsWithQuarterlyTypeOfDispensation() {
    ...
    String sqlQuery =
        "SELECT    en.patient_id      "
            ...
            + " 						AND e.encounter_datetime = last_ficha.encounter_datetime  "
            + "   "
            + "         WHERE e.encounter_datetime <= '2020-01-20'  "
            + " AND e.location_id = 208  "
            + " AND e.voided = 0  "
            + "                 AND e.encounter_type = 18  "
            + "                 AND e.patient_id = en.patient_id  "
            ...
            + "                ex.encounter_id,           "
            + "                o.obs_id,              "
            + "                o.concept_id, o.value_coded,        "
            + "                ex.encounter_datetime        "
            + "        FROM                 "
            + "            (SELECT           "
            + "            e.patient_id,         "
            + "                e.encounter_datetime,         "
            ...
            + "                AND ex.location_id = 208) AS same_day         "
            + "    WHERE                    "
            + "        same_day.concept_id in (23730,23888)          "
            + "            AND same_day.patient_id = en.patient_id)      "
            + "                     AND en.encounter_id NOT IN (SELECT               "
            + "                         same_day.encounter_id              "
            + "                     FROM              "
