...
public class QualityImprovement2020CohortQueries {
   ...
   * 165 dias e “Data de Início TARV” mais (+) 297 dias. Nota: “Data do Início TARV” é a data
   * definida no RF5.1
   *
   * @return CohortDefinition
   */
  public CohortDefinition getMQC13P3NUM_G() {
    ...
    String query =
        "SELECT cv.patient_id "
            ...
            + "WHERE  cv.cv_encounter BETWEEN Date_add(art_tbl.data_inicio, INTERVAL 165 day) "
            + "                               AND "
   ...
   * Linha” mais (+) 165 dias e “Data Última Alternativa 1ª Linha” mais (+) 297 dias.
   *
   * @return CohortDefinition
   */
   ...
   * (+) 165 dias e “Data Última 2ª Linha” mais (+) 297 dias.
   *
   * @return CohortDefinition
   */
  public CohortDefinition getMQC13P3NUM_I() {
    ...
    String query =
        " SELECT B2.patient_id "
            ...
            + "         WHERE  I_tbl.encounter_datetime BETWEEN Date_add(B2.regime_date, interval 165 day) AND Date_add(B2.regime_date, interval 297 day)";
   ...
   * from A) + 165 days and “Patient ART Start Date” (the oldest date from query A) + 297 days.
   *
   * @return CohortDefinition
   */
  public CohortDefinition getMQC13P3NUM_J() {
    ...
    String query =
        " SELECT p.patient_id "
            ...
            + "       AND o.concept_id = ${856}  "
            + "       AND o.value_numeric IS NOT NULL "
            + "       AND o.obs_datetime BETWEEN Date_add(tabela.art_date, INTERVAL 165 day)  "
            + "                                  AND  "
   ...
   * most recent date from B1) + 165 days and “ALTERNATIVA A LINHA - 1a LINHA Date” (the most recent
  ...
  public CohortDefinition getMQC13P3NUM_K() {
    ...
    String query =
        " SELECT   "
            ...
            + "                        AND o.concept_id = ${856} "
            + "                        AND o.value_numeric IS NOT NULL  "
            + "                        AND o.obs_datetime BETWEEN DATE_ADD(B1.regime_date, INTERVAL 165 DAY)  "
   ...
   * date from B2New) + 165 days and “Segunda Linha Date” (the most recent date from B2New) + 297
   * days.
   *
   * @return CohortDefinition
   */
  public CohortDefinition getMQC13P3NUM_L() {
    ...
    String query =
        " SELECT   "
            ...
            + "                        AND o.concept_id = ${856} "
            + "                        AND o.value_numeric IS NOT NULL  "
            + "                        AND o.obs_datetime BETWEEN DATE_ADD(B2NEW.last_consultation, INTERVAL 165 DAY)   "
