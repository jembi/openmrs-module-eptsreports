...
public class QualityImprovement2020CohortQueries {
  ...
  public CohortDefinition getMQ13(Boolean den, Integer line) {
    ...
    CohortDefinition b6e = this.getB6E();
    ...
    compositionCohortDefinition.addSearch(
        "B6E",
        EptsReportUtils.map(b6e, "startDate=${startDate},endDate=${endDate},location=${location}"));
  ...
  public CohortDefinition getMQ13P4(Boolean den, Integer line) {
    ...
    CohortDefinition adults = this.ageCohortQueries.createXtoYAgeCohort("adullts", 3, 14);
