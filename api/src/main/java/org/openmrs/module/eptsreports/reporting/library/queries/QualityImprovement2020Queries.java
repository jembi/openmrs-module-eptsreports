...
public class QualityImprovement2020Queries {
  ...
  /**
   * <b>MQ15DEN A1 </b> - GAAC (GA) (Concept Id 23724) = “INICIAR” (value_coded = concept Id 1256)<br>
   * <b>MQ15DEN A2 </b> - DISPENSA TRIMESTRAL (DT) (Concept Id 23730)  = “INICIAR” (value_coded = concept Id 1256)<br>
   *
   * @return SqlCohortDefinition
   */
   ...
   * @return SqlCohortDefinition
   */
  public static SqlCohortDefinition getMQ15DenA2(
      int adultoSeguimentoEncounterType,
      int startDrugs,
      int gaac) {
