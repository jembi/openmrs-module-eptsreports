  ...
  public String getStartDateOf3hpPiridoxinaOnFilt() {
    ...
    String query =
        "SELECT filt.patient_id, filt_3hp_start_date AS start_date "
            ...
            + "                          AND o.concept_id = ${23985} AND o.value_coded IN ( ${23954}, ${23984} )  "
            + "                          AND o.obs_datetime >= Date_sub(filt.filt_3hp_start_date, INTERVAL 4 month ) AND o.obs_datetime < filt.filt_3hp_start_date ) "
            ...
            + "                       WHERE  ee.voided = 0 "
            + "                              AND o.voided = 0 AND oo.voided = 0 "
