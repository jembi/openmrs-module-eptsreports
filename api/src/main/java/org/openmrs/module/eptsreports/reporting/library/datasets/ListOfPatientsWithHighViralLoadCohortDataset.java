...
public class ListOfPatientsWithHighViralLoadCohortDataset extends BaseDataSet {
  ...
  public DataSetDefinition contructDataset() {
    ...
    pdd.addRowFilter(
        listOfPatientsWithHighViralLoadCohortQueries.getPatientsWithUnsuppressedVlesult(),
    ...
    pdd.addColumn(
        ...
        listOfPatientsWithHighViralLoadCohortQueries.getNewLineInitiationDate(true),
        "startDate=${startDate},endDate=${endDate},location=${location}",
        new NotApplicableIfNullConverter());
    ...
    pdd.addColumn(
        "newline_initiation_date_after_third_high_vl",
        listOfPatientsWithHighViralLoadCohortQueries.getNewLineInitiationDate(false),
        "startDate=${startDate},endDate=${endDate},location=${location}",
        new NotApplicableIfNullConverter());
