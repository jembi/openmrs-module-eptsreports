...
public class TPTInitiationCohortQueries {
   ...
   * <blockquote>
   *
   * <p>Select all patients with Última profilaxia(concept id 23985) value coded 3HP(concept id 23954) 
   * and Data Início da Profilaxia TPT(value datetime, concept id 6128) 
   * registered during the reporting period on Ficha Resumo (Encounter type 53) ; <b>
   * 
   * </blockquote>
   * @return {@link CohortDefinition}
   */
   ...
   * and Estado da Profilaxia (concept id 165308) value coded Início (concept id 1256) registered during 
   * the reporting period on Ficha Clinica (Encounter type 6)  <b>
   * 
   * </blockquote>
   *
   * @return {@link CohortDefinition}
   ...
   * <blockquote>
   * 
   * <p>Select all patients with Outras prescricoes(concept id 1719) value coded DT-3HP (concept id 165307)
   * on Ficha clinica (encounter type 6) during the reporting period; <b>
   * 
   * </blockquote>
   * 
   * @return {@link CohortDefinition}
   ...
   * <blockquote>
   * <p>
   * • Select all patients with “Regime de TPT” (concept id 23985) with value coded “3HP” or ” 3HP+Piridoxina” 
   * (concept id in [23954, 23984]) and “Seguimento de tratamento TPT”(concept ID 23987) value coded “continua” 
   *  or “fim” or no value(concept ID in [1257, 1267, null]) marked on the first FILT (encounter type 60) 
   * and encounter datetime between start date and end date and:
    
    ◦ N1o other Regime de TPT (concept id 23985) value coded “3HP” or ” 3HP+Piridoxina” (concept id in [23954, 23984])
     marked on FILT (encounter type 60) in the 4 months prior to the FILT 3HP start date.  ; and
    
    ◦ No other 3HP start dates marked on Ficha clinica (encounter type 6, encounter datetime) with Profilaxia TPT 
    (concept id 23985) value coded 3HP (concept id 23954) and Estado da Profilaxia  (concept id 165308) value coded 
    Início (concept id 1256) or Outras prescrições (concept id 1719) value coded 3HP or DT-3HP (concept id 
    in [23954,165307])in the 4 months prior to the FILT 3HP start date.  ; and
    
    ◦ No other 3HP start dates marked on Ficha Resumo (encounter type 53) with Última profilaxia(concept id 23985) 
    value coded 3HP(concept id 23954) and Data Início da Profilaxia TPT(value datetime, concept id 6128) in the 4 months prior to the FILT 3HP start date.  ;
   * <b>
   * 
   * </blockquote>
   * 
  ...
  public CohortDefinition getPatientsWithRegimeDeTPT3HP(){
    ...
    String query = 
     "SELECT "
        ...
        + "      INNER JOIN encounter e ON e.patient_id = p.patient_id "
        + "      INNER JOIN obs o ON e.encounter_id = o.encounter_id "
        + "      INNER JOIN (  SELECT p.patient_id, e.encounter_datetime AS start_date "
        + "              FROM patient p "
        + "                  INNER JOIN encounter e ON p.patient_id = e.patient_id "
        + "                  INNER JOIN obs o ON e.encounter_id = o.encounter_id "
        + "                  INNER JOIN obs o2 ON e.encounter_id = o2.encounter_id "
        ...
        + "      AND o.value_coded IN (${23954}, ${23984}) "
        + "      AND e.encounter_type = ${60} "
        + "      AND e.encounter_datetime >= date_sub(filt.start_date, interval 4 month) GROUP BY p.patient_id "
        + "    UNION "
        + "    SELECT "
        + "      p.patient_id "
        + "    FROM "
        ...
        + "      AND e.location_id = :location "
        + "      AND e.encounter_type = ${6} "
        + "      AND o3.concept_id = ${23985} "
        + "      AND o3.value_coded = ${23954} "
        + "      AND o4.concept_id = ${165308} "
        + "      AND o4.value_coded = ${1256} "
        + "      OR o5.concept_id = ${1719} "
        + "      AND o5.value_coded IN (${23954}, ${165307}) "
        + "      AND e.encounter_datetime <= date_sub(filt.start_date, interval 4 month) GROUP BY p.patient_id "
        + "    UNION "
        + "    SELECT "
        + "      p.patient_id "
        ...
        + "                  AND (o.concept_id=  ${23985}   AND o.value_coded IN ( ${23954}  , ${23984} )) "
        + "                  AND (o2.concept_id=  ${23987}   AND o2.value_coded IN ( ${1256} , ${1705} )) "
        + "                  AND e.encounter_datetime BETWEEN '2020-01-30' AND '2021-01-30' "
        + "       "
        + "      ) filt on filt.patient_id = p.patient_id "
        + "    WHERE "
        + "      p.voided = 0 "
        ...
        + "      AND e.location_id = :location "
        + "      AND e.encounter_type = ${53} "
        + "      AND o6.concept_id = ${23985} "
        + "      AND o6.value_coded = ${23954} "
        + "      AND o7.concept_id = ${6128} "
        + "      AND o7.value_datetime <= date_sub(filt.start_date, interval 4 month) GROUP BY p.patient_id "
        + "  ) GROUP BY p.patient_id";
   ...
   * <blockquote>
   * 
   * <p>1: Select all patients with Ficha Resumo (encounter type 53) with “Ultima profilaxia Isoniazida (Data Inicio)” (concept id 6128) and value datetime not null 
   * or Última profilaxia(concept id 23985) value coded INH(concept id 656) and Data Início da Profilaxia TPT(value datetime, concept id 6128)  not null 
   * and exclude all patients with Última profilaxia(concept id 23985) value coded 3HP(concept id 23954) and between start date and end date.   * 
   * <b>
   * 
   * </blockquote>
   * @return {@link CohortDefinition}
   ...
   * <blockquote>
   * 
   * <p>2: Select all patients with Ficha clinica (encounter type 6) with “Profilaxia INH” (concept id 6122) with value code “Inicio” (concept id 1256) 
   * or  Profilaxia TPT (concept id 23985) value coded INH (concept id 656) and Estado da Profilaxia (concept id 165308) value coded Início (concept id 1256)   
   * and encounter datetime between start date and end date <b>
   * 
   * </blockquote>
   * 
   * @return {@link CohortDefinition}
   ...
   * <blockquote>
   * 
   * <p>3: Select all patients with Ficha clinica or Ficha Pediatrica (encounter type 6,9) with “Profilaxia com  INH” 
   * (concept id 6128) and value datetime is not null and between start date and end date. <b>
   * 
   * </blockquote>
   * 
   * @return {@link CohortDefinition}
   */
  public CohortDefinition getPatientsWithFichaClinicaPediatricaProfilaxiaInh(){

    SqlCohortDefinition cd = new SqlCohortDefinition();

    cd.setName("all patients with Ficha Clinica or Ficha Pediatrica");
    cd.addParameter(new Parameter("startDate", "startDate", Date.class));
    cd.addParameter(new Parameter("endDate", "endDate", Date.class));
    cd.addParameter(new Parameter("location", "location", Location.class));
   ...
   * 
   * <p>
   * 4: Select all patients with the First FILT (encounter type 60) with “Regime de TPT” (concept id 23985) value coded ‘Isoniazid’ or ‘Isoniazid + piridoxina’ 
   * (concept id in [656, 23982]) and “Seguimento de Tratamento TPT” (concept ID 23987) with values “Continua” (concept ID 1257) or no value(null) or concept 23987 
   * does not exist and encounter datetime (as INH Start Date) between start date and end date and:
    ◦ No other INH values [Regime de TPT” (concept id 23985) value coded ‘Isoniazid’ or ‘Isoniazid + piridoxina’ (concept id in [656, 23982])] marked on FILT in the 7 months prior to 
    ‘INH Start Date’; and
    ◦ No Última profilaxia Isoniazida (Data Início) (Concept ID 6128, value_datetime)  or Última profilaxia(concept id 23985) value coded INH(concept id 656) 
    and Data Início da Profilaxia TPT(value datetime, concept id 6128)  not null  registered in Ficha Resumo - Mastercard (Encounter Type ID 53) in the 7 months prior to ‘INH Start Date’; and 
    ◦ No Profilaxia (INH) (Concept ID 6122) with the value “I” (Início) (Concept ID 1256) or  Profilaxia TPT (concept id 23985) value coded INH (concept id 656) and Estado da Profilaxia
     (concept id 165308) value coded Início (concept id 1256) marked on Ficha Clínica - Mastercard (Encounter Type ID 6)  in the 7 months prior to ‘INH Start Date’; and 
    ◦ No Profilaxia com INH – TPI (Data Início) (Concept ID 6128, value_datetime) marked in Ficha de Seguimento (Adulto e Pediatria) (Encounter Type ID 6,9) in the 7 months prior to ‘INH Start Date’
   * <b>
   * 
   * </blockquote>
   * 
  ...
  "SELECT p.patient_id "
          ...
          + "                          e.encounter_datetime AS inh_start "
          + "                   FROM   patient p "
          + "                          inner join encounter e "
          + "                                  ON p.patient_id = e.patient_id "
          + "                          inner join obs o "
          ...
          + "                              AND e.encounter_datetime BETWEEN "
          + "                                  :startDate AND :endDate) inh_start_date "
          + "               ON p.patient_id = inh_start_date.patient_id "
          + "WHERE  p.voided = 0 "
          + "       AND e.voided = 0 "
          + "       AND o.voided = 0 "
          + "       AND p.patient_id NOT IN (SELECT p.patient_id "
          ...
          + "                                       AND o6.voided = 0 "
          + "                                       AND e.location_id = :location "
          + "                                       AND o4.concept_id = ${6128} "
          + "                                       AND o4.value_coded = ${1256} "
          + "                                        OR o5.concept_id = ${23985} "
          + "                                           AND o5.value_coded = ${656} "
          + "                                           AND o6.concept_id = ${165308} "
          + "                                           AND o6.value_coded = ${1256} "
          + "                                           AND e.encounter_type = ${6} "
          + "                                           AND e.encounter_datetime <= "
          + "                                               Date_sub( "
   ...
   * <blockquote>
   * 
   * <p>5: Select all patients with “Regime de TPT” (concept id 23985) value coded ‘Isoniazid’ or ‘Isoniazid + piridoxina’ (concept id in [656, 23982]) and  
   * “Seguimento de tratamento TPT”(concept ID 23987) value coded “inicio” or “re-inicio”(concept ID in [1256, 1705]) marked on FILT (encounter type 60) and e
   * ncounter datetime between start date and end date <b>
   * 
   * </blockquote>
   * 
   * @return {@link CohortDefinition}
  ...
  public CohortDefinition getpatientswithRegimeTPTIsoniazid(){
      ...
      String query = 
            ...
            + "       AND e.location_id = :location "
            + "       AND e.encounter_type = ${60} "
            + "       AND o1.concept_id = ${23985} "
            + "       AND o1.value_coded IN( ${656}, ${23982} ) "
            + "       AND o2.concept_id = ${23987} "
