  ...
  public CohortDefinition getPatientsWithFirstFiltRegimeTpt() {
    ...
    String query =
        "SELECT p.patient_id "
            ...
            + "                   FROM   patient p "
            + "                          inner join encounter e ON p.patient_id = e.patient_id "
            + "                          inner join encounter e1 ON e.encounter_id = e1.encounter_id "
            + "                          inner join obs o ON e.encounter_id = o.encounter_id "
            + "                          inner join obs o2 ON e.encounter_id = o2.encounter_id "
            + "                   WHERE  p.voided = 0 AND e.voided = 0 AND o.voided = 0 AND o2.voided = 0 "
            + "                          AND e.location_id = :location "
            ...
            + "                          AND ( o2.concept_id = ${23987} AND o2.value_coded = ${1257} OR o2.value_coded IS NOT NULL ) ) "
            + "                          AND e.encounter_datetime BETWEEN :startDate AND :endDate) inh_start_date "
            ...
            + "                                       inner join obs o2 ON e.encounter_id = o2.encounter_id "
            + "                                       inner join obs o3 ON e.encounter_id = o3.encounter_id "
            + "                                WHERE  p.voided = 0 AND e.voided = 0 AND o1.voided = 0 AND o2.voided = 0 AND o3.voided = 0 "
            + "                                       AND e.location_id = :location "
            + "                                       AND e.encounter_type = ${53} "
            + "                                       AND ( o1.concept_id = ${6128} AND o1.value_datetime IS NOT NULL ) "
            + "                                        OR ( o2.concept_id = ${23985} AND o2.value_coded = ${656} "
            + "                                           AND o3.concept_id = ${6128} AND o3.value_datetime IS NOT NULL ) "
            + "                                           AND e.encounter_datetime <= Date_sub(inh_start_date.inh_start, interval 7 month) "
            + "                                UNION "
            ...
            + "                                       inner join obs o5 ON e.encounter_id = o5.encounter_id "
            + "                                       inner join obs o6 ON e.encounter_id = o6.encounter_id "
            + "                                WHERE  p.voided = 0 AND e.voided = 0 AND o4.voided = 0 AND o5.voided = 0 AND o6.voided = 0 "
            + "                                       AND e.location_id = :location "
            + "                                       AND e.encounter_type = ${6} "
            + "                                       AND ( o4.concept_id = ${6122} "
            ...
            + "                                       inner join encounter e ON p.patient_id = e.patient_id "
            + "                                       inner join obs o7 ON e.encounter_id = o7.encounter_id "
            + "                                WHERE  p.voided = 0 AND e.voided = 0 AND o7.voided = 0 "
            + "                                       AND e.location_id = :location "
