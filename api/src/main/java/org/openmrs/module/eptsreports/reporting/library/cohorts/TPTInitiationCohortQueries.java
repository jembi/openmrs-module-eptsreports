...
public class TPTInitiationCohortQueries {
   ...
   * reporting period on Ficha Resumo (Encounter type 53) ; <b>
   *
   * </blockquote>
   *
   * @return {@link CohortDefinition}
   ...
   * registered during the reporting period on Ficha Clinica (Encounter type 6) <b>
   *
   * </blockquote>
   *
   * @return {@link CohortDefinition}
   ...
   * 165307) on Ficha clinica (encounter type 6) during the reporting period; <b>
   *
   * </blockquote>
   *
   * @return {@link CohortDefinition}
   ...
   * TPT(value datetime, concept id 6128) in the 4 months prior to the FILT 3HP start date.  ; <b>
   *
   * </blockquote>
   *
   * @return {@link CohortDefinition}
   ...
   * (concept id 1256)    and encounter datetime between start date and end date <b>
   *
   * </blockquote>
   *
   * @return {@link CohortDefinition}
   ...
   * <blockquote>
   *
   * <p>3: Select all patients with Ficha clinica or Ficha Pediatrica (encounter type 6,9) with
   * “Profilaxia com  INH” (concept id 6128) and value datetime is not null and between start date
   * and end date. <b>
   *
   * </blockquote>
   ...
   * between start date and end date and: ◦ No other INH values [Regime de TPT” (concept id 23985)
   * value coded ‘Isoniazid’ or ‘Isoniazid + piridoxina’ (concept id in [656, 23982])] marked on
   * FILT in the 7 months prior to ‘INH Start Date’; and ◦ No Última profilaxia Isoniazida (Data
   * Início) (Concept ID 6128, value_datetime)  or Última profilaxia(concept id 23985) value coded
   * INH(concept id 656) and Data Início da Profilaxia TPT(value datetime, concept id 6128)  not
   * null  registered in Ficha Resumo - Mastercard (Encounter Type ID 53) in the 7 months prior to
   * ‘INH Start Date’; and  ◦ No Profilaxia (INH) (Concept ID 6122) with the value “I” (Início)
   * (Concept ID 1256) or  Profilaxia TPT (concept id 23985) value coded INH (concept id 656) and
   * Estado da Profilaxia (concept id 165308) value coded Início (concept id 1256) marked on Ficha
   * Clínica - Mastercard (Encounter Type ID 6)  in the 7 months prior to ‘INH Start Date’; and  ◦
   * No Profilaxia com INH – TPI (Data Início) (Concept ID 6128, value_datetime) marked in Ficha de
   * Seguimento (Adulto e Pediatria) (Encounter Type ID 6,9) in the 7 months prior to ‘INH Start
   * Date’ <b>
   *
   * </blockquote>
   *
   ...
   * ‘Isoniazid + piridoxina’ (concept id in [656, 23982]) and   “Seguimento de tratamento
   * TPT”(concept ID 23987) value coded “inicio” or “re-inicio”(concept ID in [1256, 1705]) marked
   * on FILT (encounter type 60) and e ncounter datetime between start date and end date <b>
   *
   * </blockquote>
   *
   * @return {@link CohortDefinition}
