...
public class TPTInitiationCohortQueries {
   ...
   * 23954) and Data Início da Profilaxia TPT(value datetime, concept id 6128) selected in Ficha
   * Resumo - Mastercard (Encounter type 53) (3HP Start Date) between endDate-4 months and endDate
   *
   * </blockquote>
   *
   * @return {@link CohortDefinition}
   ...
   * on Ficha Clínica – Mastercard (Encounter type 6) (3HP Start Date) between endDate-4 months and
   * endDate or
   *
   * </blockquote>
   *
   ...
   * 165307) marked in Ficha Clínica – Mastercard (Encounter type 6) (3HP Start Date) between
   * endDate-4 months or
   *
   * </blockquote>
   *
   ...
   * the first FILT (encounter type 60) and encounter datetime between endDate – 4 months and
   * endDate as “FILT Start Date” and:
   *
