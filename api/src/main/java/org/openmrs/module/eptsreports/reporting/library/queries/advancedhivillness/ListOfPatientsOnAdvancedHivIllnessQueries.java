...
public class ListOfPatientsOnAdvancedHivIllnessQueries {
  ...
  public String getVLoadResultAndMostRecent() {
    return "SELECT p.patient_id, "
        ...
        + "                                                                                                                                      limit 1 ), (if(e.encounter_type = 51 and o2.value_coded=1306, 'NIVEL DE DETECÇÃO BAIXO', (IF (o2.value_coded = 23814,'INDETECTÁVEL', (SELECT cn.name FROM concept_name cn where concept_id = o2.value_coded AND locale = 'pt' limit 1) ))     ))) )) AS "
        + "       viral_load "
        + "FROM   patient p "
        + "       INNER JOIN encounter e "
